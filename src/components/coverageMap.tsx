...
const todasAsCidades = [
    ...
    { nome: 'Cristiano Otoni', top: '73%', left: '63%' },
    { nome: 'Casa Grande', top: '78%', left: '59%' },
    { nome: 'Capela Nova', top: '75%', left: '68.5%' },
    { nome: 'Queluzito', top: '74%', left: '60%' },
    { nome: 'Santana dos Montes', top: '78%', left: '65%' },
    { nome: 'Caranaíba', top: '75%', left: '66%' },
    ...
    { nome: 'Rio Espera', top: '75%', left: '71%' },
    { nome: 'Lamin', top: '71%', left: '71%' },
    { nome: 'Senhora de Oliveira', top: '74%', left: '74%' },
